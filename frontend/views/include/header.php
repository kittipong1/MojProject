<header class="clearfix">
    ...
    <div class="navbar navbar-default navbar-top" role="navigation" data-spy="affix" data-offset-top="50">
            ...
            <div class="navbar-collapse collapse">
                ...
                <ul class="nav navbar-nav navbar-right">
                    ...
                    <li>
                        ...
                        <!-- <ul class="dropdown">
                            <li><a href="knowledge.php">About</a>
                            </li>
                    ...
                    <!--<li>
                        <a href="knowledge.php">องค์ความรู้</a>
                        <ul class="dropdown">
                            <li><a href="knowledge.php">About</a>
                            </li>
                            <li><a href="services.html">Services</a>
                    ...
                    <li>
                        <a href="publicize.php">ประชาสัมพันธ์</a>
                        <!-- <ul class="dropdown">
                            <li><a href="knowledge.php">About</a>
                            </li>
                            <li><a href="services.html">Services</a>
                    ...
                    <!--<li>
                        <a href="palace.php">ทำเนียบ KM FA</a>
                         <ul class="dropdown">
                            <li><a href="portfolio-2.html">2 Columns</a>
                            </li>
                            <li><a href="palace.php">3 Columns</a>
                            </li>
        ...
        <ul class="wpb-mobile-menu">
            ...
            <!--<li>
                <a href="magazine.php">หนังสืออิเล็กทรอนิกส์</a>
                 <ul class="dropdown">
                    <li><a href="blog.html">Blog - right Sidebar</a>
                    </li>
                    <li><a href="blog-left-sidebar.html">Blog - Left Sidebar</a>
