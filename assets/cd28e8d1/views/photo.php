            ...
            <?php  
              ...
              <div class="post-head">
                <div class="touch-slider post-slider">
                  ...
                  <div class="item">
                    <a class="lightbox" title="รายละเอียดรูปภาพ..." href="images/img-gallery-2.png" data-lightbox-gallery="gallery1">
                      <div class="thumb-overlay"><i class="fa fa-arrows-alt"></i></div>
                      <img alt="" src="images/img-gallery-2.png">
                    </a>
                  </div>
                  <div class="item">
                    <a class="lightbox" title="รายละเอียดรูปภาพ..." href="images/img-gallery-3.png" data-lightbox-gallery="gallery1">
                      <div class="thumb-overlay"><i class="fa fa-arrows-alt"></i></div>
                      <img alt="" src="images/img-gallery-3.png">
                    </a>
                  </div>
                </div>
              </div>
